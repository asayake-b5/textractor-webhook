...
Alternatively, you can use our provided server (see [[https://github.com/sdbversini/textractor-webhook/releases/tag/1.0.0][here]]), to pipe the output to firefox.
** How To Use
